...
import 'package:herraf_app/acceptspeloutone.dart';
import 'package:herraf_app/acronym1.dart';
import 'package:page_transition/page_transition.dart';

class GamescreenThree extends StatefulWidget {
  const GamescreenThree({Key? key}) : super(key: key);

  @override
  State<GamescreenThree> createState() => _GamescreenThreeState();
}

class _GamescreenThreeState extends State<GamescreenThree> {
  @override
                        ...
                        onTap: () {
                          showDialog(
                              ...
                              builder: (ctx) => AlertDialog(
                                  shape: Border.all(
                                      width: 3, color: const Color(0xff0093ED)),
                                  content: SizedBox(
